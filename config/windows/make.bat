...
C:\Python27\python.exe ..\pyinstaller\pyinstaller.py --hidden-import artifacts --hidden-import requests --hidden-import dpkt --hidden-import IPython --onedir tools\log2timeline.py
